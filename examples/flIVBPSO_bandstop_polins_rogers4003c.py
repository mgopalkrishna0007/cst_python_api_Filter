...
def calculate_pcr(matrix, inputparameters): 
    ...
    try:
        ...
        myCST.Build.Material.addNormalMaterial(
            "Rogers RO4003C (loss free)", 
            3.55, 
            1.0, 
            colour=[0.55, 0.0, 0.0],  # Deep red
            tanD=0.0, 
            sigma=0.0, 
            tanDM=0.0, 
            sigmaM=0.0
        ...
        myCST.Build.Shape.addBrick(
            ...
            name="Substrate", component="component1", material="Rogers RO4003C (loss free)"
        )
