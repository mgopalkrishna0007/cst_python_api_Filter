...
class Shape:
    ...
    def addBrick(
        self, xMin: Union[float, str , int], xMax: Union[float, str , int],
        yMin: Union[float, str, int], yMax: Union[float, str , int],
        zMin: Union[float, str , int], zMax: Union[float, str, int],name: str, component: str, material: str):
